public class StatsDriver {
	public static void main(String[] args) {
		...
		System.out.println("\nAbove call should print -1.5 but prints -1 (due to typecast)");
		System.out.print("\n");
		...
		System.out.println(Stats.geoMean(3.0, 27.0, 9.0));
		System.out.println("Above call should print something very close to \"9.0\"");
		System.out.print("\n");
